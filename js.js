...
function testFunction() {
  if (middleBar.classList.contains("rot-45deg")) {
    ...
    setTimeout(function(){ menu.classList.remove("menuHide") }, 1200);
  } else {
...
document.getElementById('hamburger-container').addEventListener("click", testFunction);
...
document.getElementById("thisFrom").addEventListener("submit", function(){
  event.preventDefault();
  verzend_formulier(this);
});
